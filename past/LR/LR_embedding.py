...
class LR(object):
    def __init__(self, feature_nums, field_nums, lr=0.5, num_class=1, threshold=0.5):
        self.lr = lr
    ...
    def defineModel(self):
        ...
        self.y = tf.placeholder(tf.float32, [None, self.N_CLASSES]) # None * 1
        ...
        with tf.variable_scope('linear_layer'):
            ...
            with tf.name_scope('logits'):
                ...
                self.yhat_prob = tf.nn.sigmoid(self.yhat)
            ...
            with tf.name_scope('optimizer'):
                ...
                optimizer = tf.train.FtrlOptimizer(learning_rate=self.lr) #, global_step=self.global_step
            ...
            with tf.name_scope('accuracy'):
                ...
                self.y_pred = tf.cast(self.yhat_prob > self.threshold, tf.int32)
