...
tf.app.flags.DEFINE_string('log_dirs', './log_dir_lr', 'the path to save log')
...
tf.app.flags.DEFINE_string('model_type', 'LR', 'name of model')
...
def train(sess, model, train_features, train_labels, batch_size, epochs, checkpoint_dir='./checkpoint', log_dir='./log_dir'):
